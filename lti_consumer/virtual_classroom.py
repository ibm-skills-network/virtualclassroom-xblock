...
from .lti_consumer import DOCS_ANCHOR_TAG_OPEN
from .lti_consumer import LaunchTarget
...
class VirtualClassroomXBlock(LtiConsumerXBlock):
    """
     This XBlock extends the LtiConsumerXBlock to provide a default configuration suitable for Skills Network Virtual Classroom.
     """
